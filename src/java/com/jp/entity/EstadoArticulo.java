...
@NamedQueries({
    ...
    @NamedQuery(name = "EstadoArticulo.findById", query = "SELECT e FROM EstadoArticulo e WHERE e.id = :id"),
    @NamedQuery(name = "EstadoArticulo.findByDescripcion", query = "SELECT e FROM EstadoArticulo e WHERE e.descripcion = :descripcion")})
public class EstadoArticulo implements Serializable {
    ...
    @OneToMany(mappedBy = "estadoArticuloId")
    private Collection<Articulos> articulosCollection;

    public EstadoArticulo() {
    }

    public EstadoArticulo(Integer id) {
        this.id = id;
    }

    public EstadoArticulo(Integer id, String descripcion) {
        this.id = id;
    ...
    public String toString() {
        return "com.jp.entity.EstadoArticulo[ id=" + id + " ]";
    }
